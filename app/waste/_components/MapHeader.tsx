    ...
    <div className="absolute top-4 left-0 w-full z-40 flex items-start pointer-events-none">
        ...
        <div className="w-full sm:w-[360px] flex items-center gap-2 pointer-events-auto bg-white rounded-full shadow-md overflow-hidden">
          ...
          <div className="relative flex-1">
            <input
              ...
              className="w-full bg-transparent py-3 pl-5 pr-10 outline-none font-open-sauce text-sm text-gray-700"
            />
      ...
      <div className="hidden sm:flex items-center gap-2 pointer-events-auto pl-4">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-full shadow-md text-sm font-open-sauce transition-colors border ${activeFilter === "vendor"
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-full shadow-md text-sm font-open-sauce transition-colors border ${activeFilter === "tps"
              ? "bg-[#17458f] text-white border-[#17458f]"
              : "bg-white text-gray-700 border-gray-200 hover:bg-gray-50"
            }`}
        >

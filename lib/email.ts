...
export type OtpEmailType = "register" | "forgot_password" | "login_verify";
...
const EMAIL_MESSAGES: Record<OtpEmailType, string> = {
  ...
  forgot_password:
    "Kami menerima permintaan reset kata sandi untuk akun Anda. Gunakan kode berikut untuk melanjutkan.",
  login_verify:

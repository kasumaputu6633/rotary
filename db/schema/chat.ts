...
export const conversations = pgTable(
  ...
  (t) => [
    // Satu sesi chat per pasang buyer dan seller.
    // Memungkinkan A beli dari B, dan B beli dari A menjadi dua sesi terpisah.
    uniqueIndex("conversations_role_pair_unique").on(
      t.buyerId,
      t.sellerId,
    ),
